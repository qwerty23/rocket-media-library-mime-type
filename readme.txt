...
2. 미디어 라이브러리에서  특정 확장자의 파일 목록만 선택해서 볼 수 있습니다. 예를들어 hwp 파일만 목록에 표시할 수 있습니다.
...
* 워드프레스 플러그인 <a href="https://wordpress.org/plugins/rocket-font" target="_blank">로켓폰트</a> 링크
* 로켓폰트 <a href="https://github.com/qwerty23/rocket-font" target="_blank">깃허브</a> 링크

== Installation ==

일반적인 워드프레스 플러그인 설치와 같습니다.

1. **워드프레스 관리자 화면의 플러그인 검색**에서 **업로드 파일** 혹은 **Rocket Upload** 로 검색해서 설치, 활성화하면 됩니다.
...
1. [깃허브 이슈 게시판](https://github.com/qwerty23/rocket-media-library-mime-type/issues) (깃허브 계정 필요) 
...
= 2.1.0 =
* fix : 번역 API 변경 (네이버 > 네이버 파파고)
* fix : 한글 파일일 경우 영문으로 번역한 후에 스페이스,대쉬 문자를 없애도록 변경
